...
public class LogarithmicSortTest {
    ...
    public void test01_checkShellSort() throws IOException {
        Assert.assertTrue(isSorted(ShellSort.sort(Arrays.copyOf(array, array.length))));
    }

    @Test
    public void test02_checkMergeSort() throws IOException {
        Assert.assertTrue(isSorted(MergeSort.sort(Arrays.copyOf(array, array.length))));
    }

    @Test
    public void test_04_checkQuickSort() throws IOException {
        Assert.assertTrue(isSorted(QuickSort.getSortedArray(Arrays.copyOf(array, array.length))));
    }
}